...
private static final long serialVersionUID = 1L;
	...
	/** Static color of the paddle */
		...
		private GRect bottom1;
		private GLabel firstLevel;
		
		private static final int BOTTOMWIDTH = WIDTH-200;
		private static final int BOTTOMHEIGHT = 40;
	...
	/*	public void run() 
		...
		public void mouseClicked(MouseEvent e)
		{
			...
			if (collObj == bottom1||collObj == firstLevel)  {
	            removeAll();
	            screen = 2;
	            pause(DELAY);
	            game();
